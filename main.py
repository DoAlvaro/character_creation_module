...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает, сколько урона получил протвник."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает, сколько урона заблокировано."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает, каким специальным умением воспользовался игрок."""
    if char_class == 'warrior':
    ...
    while approve_choice != 'y':
        char_class = input(
            'Введи название персонажа, за которого хочешь играть:\
                Вооитель — warrior, Маг — mage, Лекарь — healer: ')
        if char_class == 'warrior':
